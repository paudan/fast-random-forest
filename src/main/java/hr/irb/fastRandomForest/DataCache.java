...
public class DataCache {
    ...
    /**
     * Makes a copy of a DataCache. Most array fields are shallow copied, with
     * the exception of in inBag and whatGoesWhere arrays, which are created
     * anew.
     *
     * @param origData
     */
     ...
     *
     * @param bagSize If this is equal to the DataCache.numInstances, makes a a
     * bootstrap sample (n of of in
     ...
     * generator depends on the given seed and the contents of the sortedIndices
     * array (a single attribute is picked, its sortedIndices converted to
     * String and a hashcode computed).
     *
