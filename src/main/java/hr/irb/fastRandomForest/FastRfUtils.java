...
public class FastRfUtils {
    ...
    /**
     * Sorts a given array of floats in ascending order and returns an array of
     ...
     * Double.NaN behave unpredictably in sorting.
     *
     ...
     * using Knuth shuffle.
     * <br>
     * Copies back the current values of the previously scrambled attribute and
     * uses the given permutation to scramble the values of the new attribute
     * all by copying from the original dataset.
     *
